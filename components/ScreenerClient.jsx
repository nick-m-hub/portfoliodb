...
const ALL_COLUMNS = [
  ...
  { key: 'timing_sensitivity',      label: 'Timing Sens.', group: 'performance', defaultOn: false, definition: STAT_DEFINITIONS['Timing Sensitivity'],    format: v => v != null ? `${v.toFixed(1)}pp` : '—',   className: 'text-on-surface' },
  // Rolling Returns
