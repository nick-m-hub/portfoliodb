...
- [x] **Mobile nav "More" dropdown (May 2026)** — Replaced crowded 5-link mobile nav row with 3 primary links (Database, Screener, Strategies) + `MobileMoreMenu.jsx` client component. Compare and Membership are accessible via a "More ▾" dropdown with click-outside-to-close. Desktop nav unchanged.
