...
- [ ] **Phase 2 Step 6 — Launch** — Code complete and locally tested. Ready to commit and push (triggers Vercel auto-deploy). Post-deploy checklist: (1) fire a test webhook from Memberful → Settings → Webhooks → Send test; verify row appears in user_subscriptions; (2) make one real $12 Builder Monthly purchase to confirm full end-to-end chain; (3) announce to email list; (4) migrate any existing Ko-fi subscribers to Memberful manually.
